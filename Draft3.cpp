...
int main() {
    ...
    // each round until there are none left. That's it! 90% of the coding structure is the same!
        ...
        cout << "Starting with all features, accuracy = " << global_best_accuracy << endl << endl;
        ...
        for (int i = 0; i < num_features - 1; i++) {
            ...
            for (int feature : current_set) {
                ...
                cout << "-- Considering removing feature " << feature + 1 << endl;
            ...
            cout << "Removed feature " << feature_to_remove + 1 << " accuracy now " << best_accuracy << endl << endl;
        ...
        cout << "Final Remaining Features: ";
        for (int feature : current_set) {
            cout << feature + 1 << " " << endl;
        }

        cout << endl << "==== GLOBAL BEST RESULT ====" << endl;
        cout << "Best Accuracy: " << global_best_accuracy << endl;
        cout << "Best Feature Set: ";
